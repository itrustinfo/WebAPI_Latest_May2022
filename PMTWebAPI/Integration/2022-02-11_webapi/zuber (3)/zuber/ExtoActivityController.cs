...
namespace PMTWebAPI.Controllers
{
    public class ExtoActivityController : ApiController
    {
        ...
        [Authorize]
        [HttpPost]
        [Route("api/ExtoActivity/ResourceDeploymentAddorEdit")]
        ...
        [Authorize]
        [HttpPost]
        [Route("api/ExtoActivity/ResourceDeploymentUpdate")]
        public IHttpActionResult ResourceDeploymentUpdate()
        {
            ...
            var ResourceName = httpRequest.Params["ResourceName"];
            //var sMonth = httpRequest.Params["sMonth"];          
            var Deployed = httpRequest.Params["DeployedResource"];
            var Remarks = httpRequest.Params["Remarks"];
        ...
        public IHttpActionResult AddBankGuaranteeDocuments()
        {
            ...
            try
            {
                //Insert
                var BaseURL = HttpContext.Current.Request.Url.ToString();
                string postData = "BankDoc_UID=" + BankDoc_UID + "&Bank_GuaranteeUID=" + Bank_GuaranteeUID + "&Document_Name=" + Document_Name + "&Document_Type=" + Document_Type + "&Document_File=" + Document_File + "&RelativePath=" + RelativePath;
                db.WebAPITransctionInsert(Guid.NewGuid(), BaseURL, postData, "");
        ...
        public IHttpActionResult AddInsuranceDocuments()
        {
            ...
            try
            {
                //Insert
                var BaseURL = HttpContext.Current.Request.Url.ToString();
                string postData = "InsuranceDoc_UID=" + InsuranceDoc_UID + "&InsuranceUID=" + InsuranceUID + "&InsuranceDoc_Name=" + InsuranceDoc_Name + "&InsuranceDoc_Type=" + InsuranceDoc_Type + "&InsuranceDoc_FilePath=" + InsuranceDoc_FilePath + "&RelativePath=" + RelativePath;
                db.WebAPITransctionInsert(Guid.NewGuid(), BaseURL, postData, "");
        ...
        public IHttpActionResult AddInsurancePremium()
        {
            ...
            try
            {
                ...
                string postData = "PremiumUID=" + PremiumUID + "&InsuranceUID=" + InsuranceUID + "&Premium_Paid=" + Premium_Paid + "&Interest=" + Interest + "&Penalty=" + Penalty + "&Premium_PaidDate=" + Premium_PaidDate +
                    "&Premium_DueDate=" + Premium_DueDate + "&Next_PremiumDate=" + Next_PremiumDate + "&Premium_Receipt=" + Premium_Receipt + "&Remarks=" + Remarks + "&RelativePath=" + RelativePath;
                db.WebAPITransctionInsert(Guid.NewGuid(), BaseURL, postData, "");
