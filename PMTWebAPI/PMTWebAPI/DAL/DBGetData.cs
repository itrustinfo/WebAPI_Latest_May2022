    ...
    //    }
        ...
        public int CheckGetWebApiSettings(string Username, string Ipaddress)
        {
            ...
            try
            {
               ...
               //SqlCommand cmd = new SqlCommand("usp_GetWebAndriodSettings", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@Username", Username);
        ...
        public int checkWebAPIUser(string Username, string Password)
        {
            ...
            try
            {
                SqlConnection con = new SqlConnection(db.GetConnectionString());
                if (con.State == ConnectionState.Closed) con.Open();
               SqlCommand cmd = new SqlCommand("usp_checkAPIUser", con);
               //SqlCommand cmd = new SqlCommand("usp_checkAndriodAPIUser", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@Username", Username);
                cmd.Parameters.AddWithValue("@Password", Password);
                cnt = (int)cmd.ExecuteScalar();
        ...
        public int Issues_Status_Remarks_Insert(Guid IssueRemarksUID, Guid Issue_Uid, string Issue_Status, string Issue_Remarks, string Issue_Document, DateTime updatingDate)
        {
            int sresult = 0;
            try
            {
                using (SqlConnection con = new SqlConnection(db.GetConnectionString()))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("ups_Issue_Status_Remarks_Insert_date"))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Connection = con;
                        cmd.Parameters.AddWithValue("@IssueRemarksUID", IssueRemarksUID);
                        ...
                        cmd.Parameters.AddWithValue("@Issue_Remarks", Issue_Remarks);
                        cmd.Parameters.AddWithValue("@Issue_Document", Issue_Document);
                        cmd.Parameters.AddWithValue("@updatingDate", updatingDate);
                        con.Open();
                        sresult = (int)cmd.ExecuteNonQuery();
                        con.Close();
